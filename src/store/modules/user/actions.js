...
export default {
    fetchUser({ commit, rootGetters, rootState }, { id }) {
        ...
        user.getUser(id, rootState.auth.token).then(user => {
    ...
    fetchServers({ commit, rootGetters, rootState }, { id }) {
        ...
        user.getServers(id, rootState.auth.token).then(servers => {
    ...
    fetchProposals({ commit, rootGetters, rootState }, { id }) {
        ...
        user.getProposals(id, rootState.auth.token).then(proposals => {
